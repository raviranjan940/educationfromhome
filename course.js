...
const sksCourse = document.querySelector(".sks-course");
...
const sksCourses = document.querySelectorAll(".course.sks");

const allCourses = [htmlCourses, cssCourses, jsCourses,sksCourses];
